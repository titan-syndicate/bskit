...
type ButtonProps = BaseButtonProps & Omit<Headless.ButtonProps, 'as' | 'className'>
type ButtonLinkProps = BaseButtonProps & Omit<React.ComponentPropsWithoutRef<typeof Link>, 'className'>
...
export const ButtonLink = forwardRef(function ButtonLink(
  { color, outline, plain, className, children, to, ...props }: ButtonLinkProps,
